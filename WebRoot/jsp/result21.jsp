		...
		<html:form action="/result21" >
			...
			<table align="center" border=1 style="BORDER-COLLAPSE: collapse">
				<tr>
					...
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">产量kg</span></th>
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">总炉次数</span></th>
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">均产量kg</span></th>
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">Mg单耗</span></th>
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">TiCl<lable style="-webkit-text-size-adjust:none;font-size: 7px">4</lable>单耗</span></th>
					<th bgcolor="#99CC99"><span class="STYLE10 STYLE9">生产成品率</span></th>
				...
				<logic:notEmpty name="HANMENG1LIST">
					<logic:iterate id="result2FormBean" name="HANMENG1LIST">
				<tr>
