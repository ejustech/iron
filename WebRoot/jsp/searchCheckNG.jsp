	...
	<tr>
		<td valign="top">
			<table width="" border="0" bordercolor="#999999">
                    <tr><td align="center"><html:errors property="errors"></html:errors></td></tr>
				<tr>
					<td align="center"><input type=button value="返&nbsp&nbsp&nbsp&nbsp回" onClick="javascript:window.history.back();"></td>
				</tr>
			</table>
		</td>
	</tr>
