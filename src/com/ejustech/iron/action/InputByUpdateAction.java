...
/**
 * MyEclipse Struts Creation date: 05-26-2013
 * 
 * XDoclet definition:
 * 
 * @struts.action path="/inputByUpdate" name="inputByUpdateForm"
 *                input="/jsp/inputByUpdate.jsp" scope="request" validate="true"
 */
public class InputByUpdateAction extends EventDispatchAction {
	...
	// 处理返回跳转动作
	public ActionForward Backkk(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			if (request.getSession().getAttribute("logout") != null) {
				return mapping.findForward("relogin");
			}
